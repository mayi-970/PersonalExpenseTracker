...
import { ArrowDown, TrendingUp as ProfitIcon, PieChart as PieChartIcon, BarChart2, ChevronDown, ChevronUp, DollarSign, PiggyBank, Plus, ShoppingCart, TrendingDown, TrendingUp, Wallet, IndianRupee } from 'lucide-react';
...
const Dashboard = () => {
    ...
    // to check if date within the range
    ...
    useEffect(() => {
        ...
        //the graph will be fill acoording to this data
        setGaugeData([
